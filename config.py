...
WATCHLIST = ["NIFTY 50", "NIFTY BANK", "SENSEX "]  # Correct trading symbols
...
# Lot sizes as per Kite platform (2026)
INDICES = {
    "NIFTY": {"symbol": "NIFTY 50", "lot_size": 65, "strike_step": 50},
    "BANKNIFTY": {"symbol": "NIFTY BANK", "lot_size": 30, "strike_step": 100},
    "SENSEX": {"symbol": "SENSEX", "lot_size": 20, "strike_step": 100}
}
